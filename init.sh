...
#yum install -y mysql
# this whole thing is terribly insecure, running this as root? EleGiggle
...
# running this as anyone is probably not ideal, especially root/ec2-user.. too lazy to create an actual user and do proper permissions
